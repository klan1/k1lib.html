...
class top_bar_ extends \k1html\html\tag {
    ...
    function __construct(\k1html\html\tag $parent) {
        ...
        $this->menu_left = new \k1html\html\ul("dropdown menu", "k1lib-menu-left");
        ...
        $this->menu_right = new \k1html\html\ul("dropdown menu", "k1lib-menu-right");
     ...
     * @param string $class
     * @param string $id
     * @return \k1html\html\a
     */
    function add_button($href, $label, $class = NULL, $id = NULL) {
        $a = new \k1html\html\a($href, $label, "_self", "button $class", $id);
     ...
     */
    function add_menu_item($href, $label, \k1html\html\tag $where = NULL) {
        if (empty($where)) {
     ...
     * @return \k1html\html\li
     */
    function add_sub_menu(\k1html\html\li $where) {
    ...
    function init_title_bar() {
        ...
        $title->append_child((new \k1html\html\button(NULL, "menu-icon"))->set_attrib("data-toggle", TRUE));
